...
export const Translations = {
    en: {
        ...
        voteAllowed: 'You are allowed to vote on the election(s) below. Click on an election title to display its ballot.',
        displayResults: 'The results of the election(s) listed below are available. Click on an election title to access them.',
        noResultsAvailable: 'There is no available result.',
        shuffle: 'Shuffle',
        decrypt: 'Decrypt',
